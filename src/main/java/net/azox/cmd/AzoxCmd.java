package net.azox.cmd;

import net.azox.cmd.command.impl.home.DelHomeCommand;
import net.azox.cmd.command.impl.home.EditHomeCommand;
import net.azox.cmd.command.impl.home.HomeCommand;
import net.azox.cmd.command.impl.home.HomesCommand;
import net.azox.cmd.command.impl.home.PHomeCommand;
import net.azox.cmd.command.impl.home.SetHomeCommand;
import net.azox.cmd.command.impl.teleport.BackCommand;
import net.azox.cmd.command.impl.teleport.RtpCommand;
import net.azox.cmd.command.impl.teleport.TpaCommand;
import net.azox.cmd.command.impl.teleport.TpaHereCommand;
import net.azox.cmd.command.impl.teleport.TpAcceptCommand;
import net.azox.cmd.command.impl.teleport.TpDeclineCommand;
import net.azox.cmd.command.impl.teleport.TpIgnoreCommand;
import net.azox.cmd.command.impl.teleport.TpoCommand;
import net.azox.cmd.command.impl.util.AdminCommand;
import net.azox.cmd.command.impl.util.AdminUtilCommands;
import net.azox.cmd.command.impl.util.ClearInventoryCommand;
import net.azox.cmd.command.impl.util.ConfigCommand;
import net.azox.cmd.command.impl.util.CondenseCommand;
import net.azox.cmd.command.impl.util.GamemodeCommand;
import net.azox.cmd.command.impl.util.GuiCommand;
import net.azox.cmd.command.impl.util.ILiveCommand;
import net.azox.cmd.command.impl.util.InventoryUtilCommands;
...
import net.azox.cmd.command.impl.util.NightVisionCommand;
import net.azox.cmd.command.impl.util.PermEffectCommand;
import net.azox.cmd.command.impl.util.PlayerUtilCommands;
import net.azox.cmd.command.impl.util.PotionCommands;
import net.azox.cmd.command.impl.util.RemoveCommand;
import net.azox.cmd.command.impl.util.RulesCommand;
import net.azox.cmd.command.impl.util.SeeCommand;
import net.azox.cmd.command.impl.util.SettingsCommand;
import net.azox.cmd.command.impl.util.SilenceCommand;
import net.azox.cmd.command.impl.util.SpawnCommand;
import net.azox.cmd.command.impl.util.SpeedCommand;
import net.azox.cmd.command.impl.util.SystemCommands;
import net.azox.cmd.command.impl.util.TpCommand;
import net.azox.cmd.command.impl.util.VanishCommand;
import net.azox.cmd.command.impl.util.WeatherCommand;
import net.azox.cmd.command.impl.warp.SetWarpCommand;
import net.azox.cmd.command.impl.warp.WarpCommand;
...
import net.azox.cmd.manager.HomeManager;
...
import net.azox.cmd.manager.VanishManager;
import net.azox.cmd.manager.WarpManager;
...
@Getter
public final class AzoxCmd extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.getLogger().info("AzoxCmd has been enabled!");
    }
    ...
    public void onDisable() {
        this.getLogger().info("AzoxCmd has been disabled!");
    }
}
